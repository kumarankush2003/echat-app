...
import { userVerification, verifyEmailLink } from "../Redux/Reducer/Auth/auth.action";
        ...
        {status ? (
          <>
            <div className="flex flex-col items-center justify-center w-3/4">
              <GoMail className="w-2/4 h-2/4" color="#8af859" />
          ...
          <>
            <div className="flex flex-col items-center justify-center w-3/4">
              <GoMail className="w-2/4 h-2/4" color="#faab07" />
